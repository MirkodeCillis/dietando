...
# Disclaimer
1. As it is possible to see in the first commit, **Google AI Studio has been used** to get the first version of the application. From that point on, every change made in the project is of the author.
2. The application is not tested in Mac, Windows and iOS.
